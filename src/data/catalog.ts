...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'rings',
    price: 68000,
    material: 'Sample — client photograph',
    blurb: 'Sample image for layout testing. Not a real listing.',
    description:
      'This is a sample entry used to see how the client’s own photography sits in the shop grid and on a product page. The photograph is real; the name, price and copy are not. Remove these before launch.',
    details: ['Sample entry', 'Photograph is real', 'Name and price are not', 'Remove before launch'],
    image: '/products/rng-09.jpg',
  },
  {
    sku: 'RNG-10',
    slug: 'sample-ring-02',
